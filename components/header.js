...
const DarkModeToggleButton = dynamic(() => import('./dark-mode-toggle-button'), { ssr: false });
        ...
        <div>
            <header className="text-gray-600 body-font">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <a href="https://open.kakao.com/o/sXBeZVYg" className="mr-5 hover:text-gray-900">contact</a>
                    </nav>
                    {/* 다크모드 토글 버튼 작업해야함 */}
